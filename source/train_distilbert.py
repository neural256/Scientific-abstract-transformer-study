"""Fine-tune DistilBERT for scientific abstract classification.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=SAVED_MODELS_DIR / "distilbert")
    parser.add_argument("--metrics-path", type=Path, default=RESULTS_DIR / "distilbert_metrics.json")
    parser.add_argument(
        "--figure-path",
        type=Path,
        default=FIGURES_DIR / "confusion_matrix_distilbert.png",
    )
...
def main() -> None:
    ...
    train_hf_classifier(
        ...
        display_name="Fine-tuned DistilBERT",
        sample_config={
            "max_train_samples": args.max_train_samples,
            "max_val_samples": args.max_val_samples,
            "max_test_samples": args.max_test_samples,
